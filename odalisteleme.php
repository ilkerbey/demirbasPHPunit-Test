...
session_start();
if(!$_SESSION["oturum"]) header("location:login.php");?><!DOCTYPE html>
<html lang="en">
	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-header">
				<h5 class="card-header-text">Güncelle / Sil</h5>
			</div>
			<div class="card-block">
					...
					<div id="simpletable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap4">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tbody>
								<? $tablo = tablocek("room","*","ORDER BY roomID desc");
									...
									$tablo=tablocek("room","*","ORDER BY roomID desc LIMIT {$limit}, {$sayfada}");
								...
								<tr role="row" class="odd">
									...
									<td> 
										<a class="col-md-7 "href="odaguncelleme.php?id=<?=$row["roomID"]?>">  
											<font color="blue">                   
										 ...
										 <a  href="odasil.php?id=<?=$row["roomID"]?>">  
											<font color="red">                   
