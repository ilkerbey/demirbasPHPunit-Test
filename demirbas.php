  ...
  <? menu();?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- 4-blocks row start --><?if($_SESSION){
				?>
				
            <div class="row m-b-30 dashboard-header">
			<?if($_SESSION["durumu"]==1){?>
                <div class="col-lg-4 col-sm-6">
                    <div class="dashboard-primary bg-primary">
                        <div class="sales-primary">
                            <a href="demirbasarama.php">  
								<font color="white">                   
								   <i class="icon-puzzle"></i>
										<div class="f-right">
											   <h3 >Demirbas Arama </h3>
										</div>
								</font>     
							 </a>
                        </div>
				...
				<div class="col-lg-4 col-sm-6">
                    <div class="dashboard-info bg-info">
                        <div class="sales-primary">
                            <a href="demirbasekleme.php">  
								<font color="white">                   
								   <i class="icon-plus"></i>
										<div class="f-right">
											   <h3 >Demirbas Ekleme </h3>
										</div>
								</font>     
							 </a>
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="bg-warning dasboard-warning">
                        <div class="sales-warning">
                            <a href="demirbaslisteleme.php">  
								<font color="white">                   
								   <i class="icon-list"></i>
										<div class="f-right">
											   <h3 >Demirbas Listeleme</h3>
										</div>
								</font>     
							 </a>
                        </div>
