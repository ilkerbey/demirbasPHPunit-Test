			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<form action="personelaramasonuc.php" name="arama" id="search" method="post">
								...
								<div class="col-lg-3 offset-lg-4 col-sm-6 offset-sm-1 col-xs-12">
									<div class="md-group-add-on">
										...
										<div class="md-input-wrapper">
											...
											<label>Personel (Ad,Soyad) Arama</label>
										<span class="md-line"></span></div>
									</div>
								</div>
								<div class="col-lg-2 col-sm-4 col-xs-12">
									<button type="submit" value="Arama" class="btn btn-sm btn-primary waves-effect waves-light">Arama
									</button>
								</div>
							</div>
							</form>
