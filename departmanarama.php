			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<form action="departmanaramasonuc.php" method="post">
								...
								<div class="col-lg-3 offset-lg-4 col-sm-6 offset-sm-1 col-xs-12">
									<div class="md-group-add-on">
										...
										<div class="md-input-wrapper">
											<input type="text" id="search-data" name="arama" class="md-form-control" required>
											<label>Departman Adını Arama</label>
