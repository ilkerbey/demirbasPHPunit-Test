...
session_start();
if(!$_SESSION["oturum"]) header("location:login.php"); header('Refresh:3;url=oda.php');?>
<!DOCTYPE html>
<html lang="en">
		...
		<div class="row">
			<?
				...
				if(id){
					...
					echo '<div class="alert alert-warning"> Personel ID Bulumadı !!!! </div>';
				}
