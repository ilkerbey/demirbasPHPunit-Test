	...
	<div class="col-sm-12">
		<div class="card">
			<div class="card-header">
				<h5 class="card-header-text"><?=$_SESSION["adi"]?></h5>
			</div>
			<div class="card-block">
					...
					<div id="simpletable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap4">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tbody><? $tablo = tablocek("user","*","ORDER BY userID asc");
									...
									$tablo=tablocek("user","*","ORDER BY userID DESC LIMIT {$limit}, {$sayfada}");
								...
								<tr role="row" class="odd">
									...
									<td>
										<a class="col-md-7 "href="kullanıcıguncelleme.php?id=<?=$row["userID"]?>">  
											<font color="blue">                   
										 ...
										 <a  href="kullanıcısil.php?id=<?=$row["userID"]?>">  
											<font color="red">                   
