...
session_start();
if(!$_SESSION["oturum"]) header("location:login1.php");
?>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<form action="odaaramasonuc.php" name="arama" id="search" method="post">
								...
								<div class="col-lg-3 offset-lg-4 col-sm-6 offset-sm-1 col-xs-12">
									<div class="md-group-add-on">
										...
										<div class="md-input-wrapper">
											<input type="text" name="arama" id="search-data" class="md-form-control" maxlength="25" required>
											<label>Oda Adını Arama</label>
