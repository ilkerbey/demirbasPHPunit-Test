					...
					<div id="simpletable_wrapper" class="dataTables_wrapper form-inline dt-bootstrap4">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<tbody>
								<? $tablo = tablocek("apartdemirbas","*","ORDER BY apartDemirbasID asc");
									...
									$tablo=tablocek("apartdemirbas","*","ORDER BY apartDemirbasID DESC LIMIT {$limit}, {$sayfada}");
								...
								<tr role="row" class="odd">
									...
									<td>
										<a class="col-md-6 "href="atamaguncelleme.php?id=<?=$row["apartDemirbasID"]?>">  
											<font color="blue">                   
										 ...
										 <a class="col-md-6 " href="atamasilme.php?id=<?=$row["apartDemirbasID"]?>">  
											<font color="red">                   
