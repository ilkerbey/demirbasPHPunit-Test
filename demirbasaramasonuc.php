  ...
  <? menu();?>
    ...
    <div class="content-wrapper">
		...
		<? if ($_POST){
						...
						$v = $db-> prepare("select * from demirbas where demirbasName like '%$ara%' or demirbasCode like '%$ara%' ");
						$v -> execute(array('%'.$ara.'%'));
			...
			<? } 	else{ ?>
							<div class="card-header">
				<h5 class="card-header-text"><?echo "<div class='alert alert-danger'>Aranan Değer bulunamadı</div>"?></h5>
						</div>
